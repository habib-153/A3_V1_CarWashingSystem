...
const initiatePayment = (paymentData) => __awaiter(void 0, void 0, void 0, function* () {
    try {
        const response = yield axios_1.default.post(config_1.default.payment_url, {
            ...
            success_url: `https://a3-v1-car-washing-system.vercel.app/api/payments/confirmation?transactionId=${paymentData.transactionId}&status=success`,
            fail_url: `https://a3-v1-car-washing-system.vercel.app/api/payments/confirmation?status=failed`,
